...
exports.desc = 'Migrates a V1 WP Docker environment to a new V2 environment. Before running this command, create a new environment using the `wpdocker create` command.';
...
exports.handler = makeCommand( async function ( { old, env, verbose } ) {
	...
	console.log( ' - If you need to run a search/replace, run `wpdocker wp search-replace <olddomain> <newdomain>`' );
} );
