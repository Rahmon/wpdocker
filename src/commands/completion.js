...
exports.handler = ({ shell }) => {
	switch (shell) {
		case 'bash': {
			...
			console.log('#');
			console.log(
				`# Installation: ${chalk.bold.cyan('wpdocker completion bash >> ~/.bashrc')}`,
			);
			console.log(
				`#    or ${chalk.bold.cyan('wpdocker completion bash >> ~/.bash_profile')} on OSX.`,
			);
			console.log('#');
		...
		case 'zsh': {
			...
			console.log(
				`# Installation: ${chalk.bold.cyan('wpdocker completion zsh >> ~/.zshrc')}`,
			);
