 ...
 *
 * Variables:
 *  rootPath    Path to the root of WP Docker. Every other path is based on this path currently
 *  srcPath     Path to the source code of WP Docker generator scripts as well as the config files copied to each project
