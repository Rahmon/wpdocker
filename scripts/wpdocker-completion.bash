...
_wpdocker_environments_completion() {
...
complete -o default -F _wpdocker_completion wpdocker
complete -o default -F _wpdocker_hosts_completion wpdocker-hosts
